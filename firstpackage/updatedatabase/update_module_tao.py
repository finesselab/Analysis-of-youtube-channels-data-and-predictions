...
def insert_new_data_to_table(video_id, date, time, title, cast1, cast2, cast3, cast4, cast5,
             view_count, like_count, dislike_count, comment_count, video_duration):
    query = '''
            INSERT INTO taaooma (video_id, upload_date, upload_time, title, cast1, cast2, cast3, cast4, cast5,
             view_count, like_count, dislike_count, comment_count, duration) 
            VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)
    '''
    row_values_to_insert = (video_id, date, time, title, cast1, cast2, cast3, cast4, cast5,
             view_count, like_count, dislike_count, comment_count, video_duration)
